...
$.extend($.easing, {
    ...
    function(t) {
        var e, i, a, n, o, s, r;
        Vicommart.$window = t(window), Vicommart.$body = t(document.body), Vicommart.status = "", Vicommart.isIE = navigator.userAgent.indexOf("Trident") >= 0, Vicommart.isEdge = navigator.userAgent.indexOf("Edge") >= 0, Vicommart.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), Vicommart.call = function(t, e) {
            setTimeout(t, e)
        }, Vicommart.parseOptions = function(t) {
            return "string" == typeof t ? JSON.parse(t.replace(/'/g, '"').replace(";", "")) : {}
        }, Vicommart.parseTemplate = function(t, e) {
            return t.replace(/\{\{(\w+)\}\}/g, (function() {
                return e[arguments[1]]
            }))
        }, Vicommart.byId = function(t) {
            return document.getElementById(t)
        }, Vicommart.byTag = function(t, e) {
            return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t)
        }, Vicommart.byClass = function(t, e) {
            return e ? e.getElementsByClassName(t) : document.getElementsByClassName(t)
        }, Vicommart.setCookie = function(t, e, i) {
            var a = new Date;
            a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3), document.cookie = t + "=" + e + ";expires=" + a.toUTCString() + ";path=/"
        }, Vicommart.getCookie = function(t) {
            ...
            return ""
        }, Vicommart.$ = function(e) {
            return e instanceof jQuery ? e : t(e)
        }, Vicommart.isOnScreen = function(t) {
        ...
        }, Vicommart.appear = function(e, i, a) {
        ...
        }, Vicommart.requestTimeout = function(t, e) {
        ...
        }, Vicommart.requestInterval = function(t, e, i) {
        ...
        }, Vicommart.deleteTimeout = function(t) {
            if (t) {
                var e = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame;
                return e ? t.val ? e(t.val) : void 0 : clearTimeout(t)
            }
        }, Vicommart.setTab = function(e) {
            Vicommart.$body.on("click", ".tab .nav-link", (function(e) {
                var i = t(this);
        ...
        }, Vicommart.initCartAction = function(e) {
            Vicommart.$body.on("click", e, (function(e) {
        ...
        }, Vicommart.initScrollTopButton = function() {
            var e = Vicommart.byId("scroll-top");
            ...
            Vicommart.call(i, 500), window.addEventListener("scroll", i, {
                passive: !0
            })
        }, Vicommart.stickyDefaultOptions = {
            minWidth: 992,
            maxWidth: 2e4,
            top: !1,
            hide: !1,
            scrollMode: !0
        }, Vicommart.stickyToolboxOptions = {
            minWidth: 0,
            maxWidth: 767,
            top: !1,
            scrollMode: !0
        }, Vicommart.stickyProductOptions = {
            minWidth: 0,
            maxWidth: 2e4,
            scrollMode: !0,
            top: !1,
            hide: !1
        }, Vicommart.windowResized = function(e) {
            return e == Vicommart.resizeTimeStamp || (void 0 === window.innerHeight && (window.innerWidth = t(window).width() + Vicommart.getScrollbarWidth()), Vicommart.resizeChanged = Vicommart.canvasWidth != window.innerWidth, Vicommart.canvasWidth = window.innerWidth, Vicommart.resizeTimeStamp = e), Vicommart.resizeChanged
        }, Vicommart.getScrollbarWidth = function() {
            if (void 0 === Vicommart.scrollbarSize) {
                var t = document.createElement("div");
                t.style.cssText = "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;", document.body.appendChild(t), Vicommart.scrollbarSize = t.offsetWidth - t.clientWidth, document.body.removeChild(t)
            }
            return Vicommart.scrollbarSize
        }, Vicommart.stickyContent = function() {
            function e(t, e) {
                return this.init(t, e)
            }

            function i() {
                Vicommart.$window.trigger("sticky_refresh.wolmart", {
                    index: 0,
                    offsetTop: 0
                })
            }
            ...
            function a(t) {
                t && !Vicommart.windowResized(t.timeStamp) || (Vicommart.$window.trigger("sticky_refresh_size.wolmart"), i())
            }
            return e.prototype.init = function(e, i) {
                    this.$el = e, this.options = t.extend(!0, {}, Vicommart.stickyDefaultOptions, i, Vicommart.parseOptions(e.attr("data-sticky-options"))), Vicommart.$window.on("sticky_refresh.wolmart", this.refresh.bind(this)).on("sticky_refresh_size.wolmart", this.refreshSize.bind(this))
                    ...
                    this.isWrap ? e || this.unwrap() : e && this.wrap(), Vicommart.sticky_top_height = 0, t && setTimeout(this.refreshSize.bind(this), 50)
                    ...
                    i > this.top && this.isWrap ? (this.height = a[0].offsetHeight, a.hasClass("fixed") || a.parent().css("height", this.height + "px"), a.hasClass("fix-top") ? (a.css("margin-top", e.offsetTop + "px"), this.zIndex = this.options.max_index - e.index) : a.hasClass("fix-bottom") ? (a.css("margin-bottom", e.offsetBottom + "px"), this.zIndex = this.options.max_index - e.index) : a.css({
                        ...
                        "z-index": this.zIndex
                    }), this.options.scrollMode ? (this.scrollPos >= i && a.hasClass("fix-top") || this.scrollPos <= i && a.hasClass("fix-bottom") ? (a.addClass("fixed"), this.onFixed && this.onFixed(), a.hasClass("product-sticky-content") && Vicommart.$body.addClass("addtocart-fixed")) : (a.removeClass("fixed").css("margin-top", "").css("margin-bottom", ""), this.onUnfixed && this.onUnfixed(), a.hasClass("product-sticky-content") && Vicommart.$body.removeClass("addtocart-fixed")), this.scrollPos = i) : (a.addClass("fixed"), this.onFixed && this.onFixed()), a.is(".fixed.fix-top") ? (e.offsetTop += a[0].offsetHeight, Vicommart.sticky_top_height = e.offsetTop) : a.is(".fixed.fix-bottom") && (e.offsetBottom += a[0].offsetHeight)) : (a.parent().css("height", ""), a.removeClass("fixed").css({
                        "margin-top": "",
                        "margin-bottom": "",
                        "z-index": ""
                    }), this.onUnfixed && this.onUnfixed(), a.hasClass("product-sticky-content") && Vicommart.$body.removeClass("addtocart-fixed"))
                }, Vicommart.$window.on("wolmart_complete", (function() {
                    window.addEventListener("scroll", i, {
                        passive: !0
                    }), Vicommart.$window.on("resize", a), setTimeout((function() {
                        a()
                    }), 300)
                })),
                function(i, a) {
                    Vicommart.$(i).each((function() {
                        var i = t(this);
                        i.data("sticky-content") || i.data("sticky-content", new e(i, a))
                    }))
                }
        }(), Vicommart.parallax = function(e, i) {
            t.fn.themePluginParallax && Vicommart.$(e).each((function() {
                var e = t(this);
                e.themePluginParallax(t.extend(!0, Vicommart.parseOptions(e.attr("data-parallax-options")), i))
            }))
        }, Vicommart.skrollrParallax = function() {
            Vicommart.isMobile || "undefined" != typeof skrollr && Vicommart.$(".skrollable").length && skrollr.init({
                forceHeight: !1
            })
        }, Vicommart.initFloatingParallax = function() {
            t.fn.parallax && Vicommart.$(".floating-item").each((function(e) {
                var i = t(this);
                i.data("parallax") && (i.parallax("disable"), i.removeData("parallax"), i.removeData("options")), i.children().addClass("layer").attr("data-depth", i.attr("data-child-depth")), i.parallax(Vicommart.parseOptions(i.data("options")))
            }))
        }, Vicommart.isotopeOptions = {
        ...
        }, Vicommart.isotopes = function(e, i) {
            if ("function" == typeof imagesLoaded && t.fn.isotope) {
                var a = this;
                Vicommart.$(e).each((function() {
                    var e = t(this),
                        n = t.extend(!0, {}, a.isotopeOptions, Vicommart.parseOptions(e.attr("data-grid-options")), i || {});
                    Vicommart.lazyLoad(e), e.imagesLoaded((function() {
                        n.customInitHeight && e.height(e.height()), n.customDelay && Vicommart.call((function() {
                            e.isotope(n)
                        }), parseInt(n.customDelay)), e.isotope(n)
                    }))
                }))
            }
        }, Vicommart.initNavFilter = function(e) {
            t.fn.isotope && Vicommart.$(e).on("click", (function(e) {
                var i = t(this),
                ...
                t(n || ".grid").isotope({
                    ...
                    Vicommart.$window.trigger("appear.check")
                })), i.parent().siblings().children().removeClass("active"), i.addClass("active"), e.preventDefault()
            }))
        }, Vicommart.ratingTooltip = function(t) {
            for (var e = Vicommart.byClass("ratings-full", t || document.body), i = e.length, a = function() {
                    var t = parseInt(this.firstElementChild.style.width.slice(0, -1)) / 20;
                    this.lastElementChild.innerText = t ? t.toFixed(2) : t
                }, n = 0; n < i; ++n) e[n].addEventListener("mouseover", a), e[n].addEventListener("touchstart", a, {
                passive: !0
            })
        }, Vicommart.setProgressBar = function(e) {
            Vicommart.$(e).each((function() {
                var e = t(this),
        ...
        }, Vicommart.alert = function(e) {
            Vicommart.$body.on("click", e + " .btn-close", (function(i) {
                i.preventDefault(), t(this).closest(e).fadeOut((function() {
                    t(this).remove()
                }))
            }))
        }, Vicommart.closeTopNotice = function(e) {
            Vicommart.$body.on("click", e, (function(e) {
                e.preventDefault(), t(".top-banner").slideUp()
            }))
        }, Vicommart.accordion = function(e) {
            Vicommart.$body.on("click", e, (function(e) {
                var a = t(this),
                    n = a.closest(".card").find(a.attr("href")),
                    o = a.closest(".accordion");
                e.preventDefault(), 0 === o.find(".collapsing").length && 0 === o.find(".expanding").length && (n.hasClass("expanded") ? o.hasClass("radio-type") || i(n) : n.hasClass("collapsed") && (o.find(".expanded").length > 0 ? Vicommart.isIE ? i(o.find(".expanded"), (function() {
                    i(n)
        ...
        }, Vicommart.animationOptions = {
            name: "fadeIn",
            duration: "1.2s",
            delay: ".2s"
        }, Vicommart.appearAnimate = function(e) {
            Vicommart.$(e).each((function() {
                var e = this;
                Vicommart.appear(e, (function() {
                    if (e.classList.contains("appear-animate")) {
                        var i = t.extend({}, Vicommart.animationOptions, Vicommart.parseOptions(e.getAttribute("data-animation-options")));
                        setTimeout((function() {
        ...
        }, Vicommart.countDown = function(e) {
            t.fn.countdown && Vicommart.$(e).each((function() {
                var e = t(this),
                    i = e.data("until"),
                    a = e.data("compact"),
        ...
        }, Vicommart.priceSlider = function(e, i) {
            "object" == typeof noUiSlider && Vicommart.$(e).each((function() {
                var e = this;
        ...
        }, Vicommart.stickySidebarOptions = {
            autoInit: !0,
            minWidth: 991,
            ...
            top: 0,
            bottom: 0
        }, Vicommart.stickySidebar = function(e) {
            if (t.fn.themeSticky) {
                var i = 0;

                function a() {
                    Vicommart.$(e).trigger("recalc.pin"), t(window).trigger("appear.check")
                    ...
                    var e = t(this);
                    e.themeSticky(t.extend({}, Vicommart.stickySidebarOptions, {
                        padding: {
                            top: i
                        }
                    }, Vicommart.parseOptions(e.attr("data-sticky-options"))))
                })), setTimeout(a, 300), Vicommart.$window.on("click", ".tab .nav-link", (function() {
                    setTimeout(a)
                }))
            }
        }, Vicommart.zoomImageOptions = {
            responsive: !0,
            borderSize: 0,
            zoomType: "inner",
            onZoomIn: !0,
            magnify: 1.1
        }, Vicommart.zoomImageObjects = [], Vicommart.zoomImage = function(e) {
            t.fn.zoom && e && ("string" == typeof e ? t(e) : e).find("img").each((function() {
                var e = t(this);
                Vicommart.zoomImageOptions.target = e.parent(), Vicommart.zoomImageOptions.url = e.attr("data-zoom-image"), e.zoom(Vicommart.zoomImageOptions), Vicommart.zoomImageObjects.push(e)
            }))
        }, Vicommart.zoomImageOnResize = function() {
            Vicommart.zoomImageObjects.forEach((function(e) {
                e.each((function() {
                    var e = t(this).data("zoom");
                    e && e.refresh()
                }))
            }))
        }, Vicommart.lazyLoad = function(t, e) {
            function i() {
                this.setAttribute("src", this.getAttribute("data-src")), this.addEventListener("load", (function() {
                    this.style["padding-top"] = "", this.classList.remove("lazy-img")
                }))
            }
            Vicommart.$(t).find(".lazy-img").each((function() {
                void 0 !== e && e ? i.call(this) : Vicommart.appear(this, i)
            }))
        }, Vicommart.initPopup = function(e, i) {
            Vicommart.$body.hasClass("home") && "true" !== Vicommart.getCookie("hideNewsletterPopup") && setTimeout((function() {
                Vicommart.popup({
                    items: {
                        src: ""
                    },
                    ...
                    callbacks: {
                        beforeClose: function() {
                            t("#hide-newsletter-popup")[0].checked && Vicommart.setCookie("hideNewsletterPopup", !0, 7)
                        }
                    }
                })
            }), 7500), Vicommart.$body.on("click", ".btn-iframe", (function(e) {
                e.preventDefault(), Vicommart.popup({
                    items: {
            ...
            })), Vicommart.$body.on("click", ".sign-in", (function(e) {
                e.preventDefault(), Vicommart.popup({
                    items: {
        ...
        }, Vicommart.initNotificationAlert = function() {
            Vicommart.$body.hasClass("has-notification") && setTimeout((function() {
                Vicommart.$body.addClass("show-notification")
            }), 5e3)
        }, Vicommart.countTo = function(e) {
            t.fn.countTo && Vicommart.$(e).each((function() {
                Vicommart.appear(this, (function() {
                    var e = t(this);
                    setTimeout((function() {
                        e.countTo({
                            onComplete: function() {
        ...
        }, Vicommart.Minipopup = (i = 0, a = [], n = !1, o = [], s = !1, r = function() {
            if (!n)
                for (var t = 0; t < o.length; ++t)(o[t] -= 200) <= 0 && this.close(t--)
        }, {
            init: function() {
                var i = document.createElement("div");
                i.className = "minipopup-area", Vicommart.byClass("page-wrapper")[0].appendChild(i), e = t(i), this.close = this.close.bind(this), r = r.bind(this)
            },
            open: function(n, l) {
                var c, d = this,
                    p = t.extend(!0, {}, Vicommart.minipopupOption, n);
                c = t(Vicommart.parseTemplate(p.template, p)), d.space = p.space;
                ...
                u.length && u.on("load", (function() {
                    ...
                    })), Vicommart.$body.on("touchstart", (function() {
                        d.resume()
        ...
        }), Vicommart.headerToggleSearch = function(t) {
            var e = Vicommart.$(t);
            Vicommart.$body.on("click", ".hs-toggle .search-toggle", (function(t) {
                t.preventDefault()
            })), "ontouchstart" in document ? (e.find(".search-toggle").on("click", (function(t) {
                e.toggleClass("show")
            })), Vicommart.$body.on("click", (function(t) {
                e.removeClass("show")
        ...
        }, Vicommart.scrollTo = function(e, i) {
            var a = void 0 === i ? 0 : i;
    ...
    function(t) {
        var e = function(t) {
                t.preventDefault(), Vicommart.$body.addClass("mmenu-active")
            },
            i = function(t) {
                t.preventDefault(), Vicommart.$body.removeClass("mmenu-active")
            },
            a = {
                init: function() {
                ...
                initMenu: function() {
                    ...
                    })), Vicommart.$window.on("resize", (function() {
                ...
                initCategoryMenu: function() {
                    ...
                    if (e.length) {
                        ...
                        if (e.hasClass("with-sidebar")) {
                            var n = Vicommart.byClass("sidebar");
                            n.length && (e.find(".dropdown-box").css("width", n[0].offsetWidth - 20), Vicommart.$window.on("resize", (function() {
                ...
                initMobileMenu: function() {
                    ...
                    })), t(".mobile-menu-toggle").on("click", e), t(".mobile-menu-overlay").on("click", i), t(".mobile-menu-close").on("click", i), Vicommart.$window.on("resize", i)
                },
    ...
    function(t) {
        ...
        var i = function(t) {
            ...
            a = function(t) {
                ...
                for (e = 0; e < a; ++e)
                    if (!i[e].classList.contains("active")) {
                        var n, o = Vicommart.byClass("appear-animate", i[e]);
            ...
            o = function() {
                ...
                t(this.wrapperEl).find(".swiper-slide-active .slide-animate").each((function() {
                    var i = t(this),
                        a = t.extend(!0, {}, Vicommart.animationOptions, Vicommart.parseOptions(i.data("animation-options"))),
                        n = a.duration,
                        o = a.delay,
                        s = a.name;
                    setTimeout((function() {
                        ...
                        n = n || "0.75s";
                        var a = Vicommart.requestTimeout((function() {
            ...
            r = function(e) {
                ...
                i.translateFlag = 1, i.prev = i.next, a.find(".swiper-slide .slide-animate").each((function() {
                    var e = t(this),
                        i = t.extend(!0, {}, Vicommart.animationOptions, Vicommart.parseOptions(e.data("animation-options")));
                ...
                if (1 == i.translateFlag) {
                    if (i.next = this.slider.activeIndex, a.find(".show-content").removeClass("show-content"), i.prev != i.next) {
                        if (a.find(".show-content").removeClass("show-content"), a.hasClass("animation-slider")) {
                            for (var n = 0; n < i.timers.length; n++) Vicommart.deleteTimeout(i.timers[n]);
                            i.timers = []
                        }
                        a.find(".swiper-slide-active .slide-animate").each((function() {
                            var e = t(this),
                                a = t.extend(!0, {}, Vicommart.animationOptions, Vicommart.parseOptions(e.data("animation-options"))),
                                n = a.duration,
                                o = a.delay,
                                s = a.name;
                            ...
                            var r = Vicommart.requestTimeout((function() {
        ...
        }, Vicommart.slider = function(i, a = {}, n = !1) {
            Vicommart.$(i).each((function() {
                var i = t(this);
                n ? new e(i, a) : Vicommart.call((function() {
                    new e(i, a)
                }))
            }))
        }, Vicommart.slider.pgToggle = function() {
    ...
    function(t) {
        ...
        e.prototype.init = function(e) {
            var a = this;
            return a.name = e, a.$sidebar = t("." + e), a.isNavigation = !1, a.$sidebar.length && (a.isNavigation = a.$sidebar.hasClass("sidebar-fixed") && a.$sidebar.parent().hasClass("toolbox-wrap"), a.isNavigation && (i = i.bind(this), Vicommart.$window.on("resize", i)), Vicommart.$window.on("resize", (function(t) {
                Vicommart.windowResized(t.timeStamp) && Vicommart.$body.removeClass(e + "-active")
                ...
                Vicommart.$body.removeClass(e + "-active"), t.preventDefault()
            }))), !1
            ...
            } else e.$sidebar.find(".sidebar-overlay .sidebar-close").css("margin-left", -(window.innerWidth - document.body.clientWidth)), Vicommart.$body.toggleClass(e.name + "-active").removeClass("closed");
            setTimeout((function() {
                t(window).trigger("appear.check")
            }), 400)
        }, Vicommart.sidebar = function(t) {
            return (new e).init(t)
        }
    }(jQuery),
    function(t) {
        var e = {
            init: function() {
                var e;
                Vicommart.call(Vicommart.ratingTooltip, 500), Vicommart.call(Vicommart.setProgressBar(".progress-bar"), 500), this.initVariation(), this.initProductsScrollLoad(".scroll-load"), Vicommart.$body.on("mousedown", ".select-menu", (function(e) {
                        var i = t(e.currentTarget),
                            a = t(e.target),
                            n = i.hasClass("opened");
                    ...
                    })), Vicommart.$body.on("click", ".select-menu a", (function(t) {
                        t.preventDefault()
                    })), Vicommart.$body.on("click", ".selected-item i", (function(e) {
                    ...
                    })), Vicommart.$body.on("mousedown", (function(e) {
                        t(".select-menu").removeClass("opened")
                    })), Vicommart.$body.on("click", ".filter-items a", (function(e) {
                        var i = t(this).closest(".filter-items");
                        i.hasClass("search-ul") || i.parent().hasClass("select-menu") || (t(this).parent().toggleClass("active"), e.preventDefault())
                    })), Vicommart.$body.on("click", ".product:not(.product-select) .btn-cart, .product-popup .btn-cart, .home .product-single .btn-cart", (function(e) {
                        e.preventDefault();
                        var i = t(this),
                            ...
                            var id = a.find(".product-title").attr("id");
                            console.log(id)
                            var update = false;
                            ...
                            if(item){
                            maincart[index].qty = maincart[index].qty + 1
                            ...
                            $(".cart-count").text(maincart.length)
                                ...
                                maincart.push({
                                id: id,
                                name: a.find(".product-title").text().trim(),
                                image: a.find(".product-media img, .product-image:first-child img").attr("src"),
                                qty: 1,
                                shipping: a.find(".product-price").attr("id").trim().substring(2).replace(/,/g, '')? a.find(".product-price").attr("id").trim().substring(2).replace(/,/g, '') : "0",
                                price: a.find(".product-price").text().trim().substring(1).replace(/,/g, ''),
                                }); 
                                localStorage.setItem("cart", JSON.stringify(maincart))
                                $(".cart-count").text(maincart.length)
                            }
                            ...
                            i.removeClass("load-more-overlay loading"), Vicommart.Minipopup.open({
                            productClass: " product-cart",
                            // name: a.find(".product-name, .product-title").text(),
                            name: a.find(".product-title").text(),
                            nameLink: a.find(".product-name > a, .product-title > a").attr("href"),
                            imageSrc: a.find(".product-media img, .product-image:first-child img").attr("src"),
                            imageLink: a.find(".product-name > a").attr("href"),
                            message: update == true? "<p>Quantity has been updated in cart:</p>" : "<p>has been added to cart:</p>",
                            actionTemplate: '<a href="/mall/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="checkout.html" class="d-none btn btn-dark btn-rounded btn-sm">Checkout</a>'
                        })
                        }), 500))
                    })), Vicommart.$body.on("click", ".product:not(.product-single) .btn-wishlist", (function(e) {
                        e.preventDefault();
                        var i = t(this);
                    ...
                    })), (e = t(".product-popup")).length && Vicommart.$body.on("click", ".btn-quickview", (function(i) {
                        i.preventDefault(), Vicommart.popup({
                            items: {
                                src: e[0].outerHTML
                            },
                            callbacks: {
                                open: function() {
                                    Vicommart.productSingle(t(".mfp-product .product-single"))
                                },
                                close: function() {
                    ...
                    function() {
                        ...
                        a.length || document.body.classList.contains("docs") || (t(".page-wrapper").append('<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="compare.html" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'), a = t(".page-wrapper > .compare-popup")), Vicommart.$body.on("click", ".product .btn-compar", (function(o) {
                            var s = t(this);
                            ...
                            r && t(".page-wrapper .product img").each((function() {
                                if (this.getAttribute("src") == r) {
                                    var e = t(this).closest(".product").find(".btn-compar");
                            ...
                            a.preventDefault(), t(".page-wrapper .product img").each((function() {
                                ...
                                i.forEach((function(t) {
                                    if (a == t) {
                                        var i = e.closest(".product").find(".btn-compar");
                        ...
                        })), Vicommart.$body.on("click", ".compare-popup-overlay", (function() {
                            a.removeClass("show")
                        }))
                    }(), Vicommart.priceSlider(".filter-price-slider")
            },
                    ...
                    window.pageYOffset > i + a.outerHeight() - window.innerHeight - 150 && "loading" != a.data("load-state") && t.ajax({
                        ...
                        success: function(e) {
                            ...
                            a.data("load-state", "loading"), a.next().hasClass("load-more-overlay") ? a.next().addClass("loading") : t('<div class="mt-4 mb-4 load-more-overlay loading"></div>').insertAfter(a), setTimeout((function() {
                                ...
                                }), 200), a.data("load-state", "loaded"), Vicommart.countDown(i.find(".product-countdown"))
                            }), 500);
    ...
    function(t) {
        ...
        e.min = 1, e.max = 1e6, e.value = 1, e.prototype.init = function(t) {
            ...
            var i = this;
            i.$minus = !1, i.$plus = !1, i.$value = !1, i.value = !1, i.startIncrease = i.startIncrease.bind(i), i.startDecrease = i.startDecrease.bind(i), i.stop = i.stop.bind(i), i.min = parseInt(t.attr("min")), i.max = parseInt(t.attr("max")), i.min || t.attr("min", i.min = e.min), i.max || t.attr("max", i.max = e.max), i.$value = t.val(t.attr("defaultvalue")), i.$minus = t.parent().find(".quantity-minus").on("mousedown", (function(t) {
            ...
            })).on("mouseup", i.stop), Vicommart.$body.on("mouseup", i.stop).on("touchend", i.stop).on("touchcancel", i.stop)
        }, e.prototype.startIncrease = function(t) {
            t && t.preventDefault();
            var e = this;
            var $val = parseInt(e.$value.val()) + 1;
            var $id = e.$value.attr("id");
            window.change2($id, $val);
            e.value = e.$value.val(), e.value < e.max && e.$value.val(++e.value), e.increaseTimer = Vicommart.requestTimeout((function() {
                e.speed = 1, e.increaseTimer = Vicommart.requestInterval((function() {
            ...
            var $id = e.$value.attr("id");
            window.change2($id, $val);
            e.value = e.$value.val(), e.value > e.min && e.$value.val(--e.value), e.decreaseTimer = Vicommart.requestTimeout((function() {
                e.speed = 1, e.decreaseTimer = Vicommart.requestInterval((function() {
                    e.$value.val(e.value = Math.max(e.value - Math.floor(e.speed *= 1.05), e.min))
                }), 50)
            }), 400)
        }, e.prototype.stop = function(t) {
            Vicommart.deleteTimeout(this.increaseTimer), Vicommart.deleteTimeout(this.decreaseTimer)
        }, Vicommart.initQtyInput = function(i) {
            Vicommart.$(i).each((function() {
                var i = t(this);
    ...
    function(t) {
        ...
        e.defaults = {
            ...
            n.isOpen ? n.content ? setTimeout((function() {
                Vicommart.popup(i, a)
            }), 5e3) : t.magnificPopup.close() : t.magnificPopup.open(t.extend(!0, {}, e.defaults, a ? e.presets[a] : {}, i)), Vicommart.$body.on("mousedown", ".mfp-wrap", o), "ontouchstart" in document && document.addEventListener("touchstart", o, {
                passive: !0
            })
        }, Vicommart.popup = function(t, i) {
            return new e(t, i)
        }
    }(jQuery),
    function(t) {
        ...
        var i = function() {
            ...
            n = function(e) {
                e.preventDefault(), Vicommart.scrollTo(t('.product-tabs > .nav a[href="' + this.getAttribute("href") + '"]').trigger("click"))
            };
        e.prototype.init = function(e) {
            var o = this,
                s = e.find(".product-single-swiper");
            o.$wrapper = e, o.isQuickView = !!e.closest(".mfp-content").length, o._isPgVertical = !1, o.isQuickView && (i = i.bind(this), Vicommart.ratingTooltip()),
                function(t) {
                    t.$thumbs = t.$wrapper.find(".product-thumbs"), t.$thumbsWrap = t.$thumbs.parent(), t.$thumbUp = t.$thumbsWrap.find(".thumb-up"), t.$thumbDown = t.$thumbsWrap.find(".thumb-down"), t.$thumbsDots = t.$thumbs.children(), t.thumbsCount = t.$thumbsDots.length, t.$productThumb = t.$thumbsDots.eq(0), t._isPgVertical = t.$thumbsWrap.parent().hasClass("product-gallery-vertical"), t.thumbsIsVertical = t._isPgVertical && window.innerWidth >= 992, Vicommart.slider(t.$thumbsWrap, {}, !0)
                }(o), document.body.classList.contains("home") || s.parent().hasClass("product-gallery-video") && (o.isQuickView || s.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>'), o.isQuickView || s.append('<a href="#" class="product-gallery-btn product-video-viewer" title="Product Video Thumbnail"><i class="w-icon-movie"></i></a>')), o.$wrapper.on("click", ".btn-wishlist", a), o.$wrapper.on("click", ".rating-reviews", n), "complete" === Vicommart.status && (Vicommart.slider(s, {
                    thumbs: {
                        swiper: o.$thumbsWrap.data("slider")
                    }
                }), Vicommart.initQtyInput(e.find(".quantity"))), s.length && window.addEventListener("resize", (function() {
                    Vicommart.requestTimeout((function() {
                    ...
                    t(e.target).find(".product-image").zoom(Vicommart.zoomImageOptions)
            ...
            o.length && (o = o.offset().top + 10, Vicommart.scrollTo(o, 500)), setTimeout((function() {
                i.isStickyScrolling = !1
            }), 300)
        }, e.prototype.scrollStickyThumbnail = function() {
            var e = this;
            this.isStickyScrolling || e.$wrapper.find(".product-image-wrapper .product-image").each((function() {
                if (Vicommart.isOnScreen(this)) return e.$wrapper.find(".product-thumbs > :nth-child(" + (t(this).index() + 1) + ")").addClass("active").siblings().removeClass("active"), !1
            }))
        ...
        }, Vicommart.productSingle = function(i) {
            return Vicommart.$(i).each((function() {
                var i = t(this);
    ...
    function(t) {
        function e(e) {
            ...
            if ((i = n.closest(".review-image").length ? n.closest(".review-image").find("img") : o.find(".product-single-swiper").length ? o.find(".product-single-swiper .swiper-slide:not(.cloned) img:first-child") : o.find(".product-gallery-carousel").length ? o.find(".product-gallery-carousel .swiper-slide:not(.cloned) img") : o.find(".product-image img:first-child")).length) {
                ...
                if ("undefined" != typeof PhotoSwipe) {
                    var c = t(".pswp")[0];
                    if ("rtl" == Vicommart.$body.attr("dir")) var d = new PhotoSwipe(c, PhotoSwipeUI_Default, a, {
                        index: l,
                        closeOnScroll: !1,
                    ...
                    d.init(), Vicommart.photoSwipe = d
                }
            }
        }

        function i(t) {
            t.preventDefault(), Vicommart.popup({
                items: {
        ...
        Vicommart.initProductSinglePage = function() {
            t(".product-gallery").each((function() {
                    var e = t(this),
                        i = e.find(".product-image");
                    i.length && 0 == e.find(".swiper-container").length && i.zoom(Vicommart.zoomImageOptions)
                })),
                function(e) {
                    var i = t(e),
                ...
                }(".product-sticky-content"), document.body.classList.contains("home") || Vicommart.$body.on("click", ".product-image-full", e).on("click", ".review-image img", e).on("click", ".product-video-viewer", i).on("click", ".product-degree-viewer", (function(e) {
    ...
    function(t) {
        Vicommart.initCodePopup = function() {
            ...
            })), Vicommart.$body.on("click", ".box-btn.showcode", (function() {
                var e = t(this);
            ...
            })), Vicommart.$body.on("click", ".show-code", (function(e) {
                e.stopPropagation();
                var i = t(this).parent();
                if (i.hasClass("show-code-added")) {
                    var a = i[0].lastElementChild;
                    i[0].removeChild(a), t(".code-popup #textareaCode").text(i.data("codepopup")), t(".code-copy a").html('<i class="copy-icon far fa-copy"></i>Copy to Clipboard'), Vicommart.$body.on("click", ".code-copy a", (function(e) {
            ...
            })), Vicommart.$body.on("mouseenter mouseleave", ".show-code-action", (function(t) {
                t.stopPropagation()
            }))
        }
    }(jQuery),
    function(t) {
        ...
        e.defaultOptions = {
            ...
            var o = this;
            o.element = a, o.settings = t.extend({}, !0, e.defaultOptions, Vicommart.parseOptions(a.attr("data-calendar-options")), n), o.today = new Date, i = i.bind(this);
        ...
        }, Vicommart.calendar = function(i, a) {
            Vicommart.$(i).each((function() {
                var i = t(this);
                Vicommart.call((function() {
                    new e(i, a)
                }))
            }))
        }, Vicommart.initVendor = function(e) {
            var i = t(e),
        ...
        }, Vicommart.slideContent = function(e) {
            var i = t(e),
                a = i.next();
        ...
        }, Vicommart.initLoginVendor = function(e) {
            var i = t(e),
    ...
    }(jQuery), jQuery, Vicommart.initLayout = function() {
        Vicommart.isotopes(".grid:not(.grid-float)"), Vicommart.stickySidebar(".sticky-sidebar")
    }, Vicommart.init = function() {
        Vicommart.appearAnimate(".appear-animate"), Vicommart.setTab(".nav-tabs"), Vicommart.stickyContent(".sticky-header", {
            scrollMode: !1
        }), Vicommart.stickyContent(".sticky-footer", {
            minWidth: 0,
            maxWidth: 767,
            top: 150,
            hide: !0,
            max_index: 2100,
            scrollMode: !0
        }), Vicommart.stickyContent(".sticky-toolbox", Vicommart.stickyToolboxOptions), Vicommart.stickyContent(".product-sticky-content", Vicommart.stickyProductOptions), Vicommart.parallax(".parallax"), Vicommart.skrollrParallax(), Vicommart.initFloatingParallax(), Vicommart.menu.init(), Vicommart.initScrollTopButton(), Vicommart.shop.init(), Vicommart.alert(".alert"), Vicommart.closeTopNotice(".banner-close"), Vicommart.accordion(".card-header > a"), Vicommart.sidebar("sidebar"), Vicommart.sidebar("right-sidebar"), Vicommart.productSingle(".product-single"), Vicommart.initProductSinglePage(), Vicommart.initQtyInput(".quantity"), Vicommart.initNavFilter(".nav-filters .nav-filter"), Vicommart.calendar(".calendar-container"), Vicommart.countDown(".product-countdown, .countdown"), Vicommart.initPopup(), Vicommart.initNotificationAlert(), Vicommart.countTo(".count-to"), Vicommart.initCartAction(".cart-offcanvas .cart-tog"), Vicommart.Minipopup.init(), Vicommart.headerToggleSearch(".hs-toggle"), Vicommart.initVendor(".store"), Vicommart.slideContent(".login-toggle"), Vicommart.slideContent(".coupon-toggle"), Vicommart.slideContent(".checkbox-toggle"), Vicommart.initLoginVendor(".user-checkbox"), Vicommart.initCodePopup(), Vicommart.slider(".swiper-container"), Vicommart.call(Vicommart.slider.pgToggle), Vicommart.$window.on("resize", (function() {
            Vicommart.call(Vicommart.slider.pgToggle)
        }))
    }, jQuery, window.onload = function() {
        Vicommart.canvasWidth = window.innerWidth, Vicommart.resizeTimeStamp = 0, Vicommart.resizeChanged = !1, Vicommart.status = "loaded", document.body.classList.add("loaded"), Vicommart.call(Vicommart.initLayout), Vicommart.call(Vicommart.init), Vicommart.status = "complete", Vicommart.$window.trigger("wolmart_complete")
    };