...
const VendorInfo = ({ name, projectName, createdDate, email, phone }) => {
    return (
        <div>
            <h3 className="pirple-font mt-4">Vendor Details</h3>
            <div
            ...
            <h3 className="pirple-font mt-4">Vendor Verification</h3>
            <div
                style={{ display: "flex", flexDirection: "column", gap: "1em" }}
            >
                <div>
