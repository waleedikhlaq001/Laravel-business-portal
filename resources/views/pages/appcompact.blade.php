...
<html lang="en" style="height: 100%;">
    ...
    <head>
        ...
        @if (Route::is('user.guser.show'))
            ...
            <meta name="twitter:description" content="{{substr($featured_product->description,0,55)}}"/> <!-- maximum 140 char -->
            <meta name="twitter:image"
                content="{{$image}}"/>  <!-- when you post this page url in twitter , this image will be shown -->
            <!-- twitter card ends here -->

            <!-- facebook open graph starts from here, if you don't need then delete open graph related  -->
            <meta property="og:title" content="{{$featured_product->name}} | Vicomma"/>
            <meta property="og:url" content="https://vicomma-stagingrevamp.herokuapp.com/mall/show/{{ $featured_product->id }}"/>
            <meta property="og:locale" content="en_US"/>
            <meta property="og:site_name" content="{{$featured_product->name}} | Vicomma"/>
            <!--meta property="fb:admins" content="" /-->  <!-- use this if you have  -->
            <meta property="og:type" content="website"/> <!-- 'article' for single page  -->
            <meta property="og:image"
                content="{{$image}}"/> <!-- when you post this page url in facebook , this image will be shown -->
            <!-- facebook open graph ends here -->
        @endif

        <script src="https://unpkg.com/@popperjs/core@2"></script>
        <script src="https://unpkg.com/tippy.js@6"></script>
        <!-- Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=G-YHMV75KPTY"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-YHMV75KPTY'); </script>
    ...
    <body class="hold-transition sidebar-mini" style="background: #f3f6f9;">
        ...
        <div class="page-overlay">
            <div class="new-content">
                <img src="{{asset('images/group-2623.svg')}}" alt="">
                ...
                <nav class="main-header navbar navbar-expand navbar-white navbar-light lgNavBar"
                    ...
                    <form action="" style="margin-bottom: 0px;">
                        <div class="input-group ig-border ml-1" style="border-radius: 100px;">
                            ...
                            <span class="input-group-text bg-transparent" style="border: 0;" onclick="runSearch()"><i
                    ...
                    <ul class="navbar-nav ml-auto mr-lg-5">
                        <li class="nav-item">
                            <a href="/dashboard" class="nav-link uSREICON">
                                <img alt="" class="icon" src="{{asset('images/dashboard-54811.svg')}}" height="22">
                                {{-- <i class="fas fa-trachometer text-lg" aria-hidden="true" style="color: var(--snd-color)"></i> --}}
                            </a>
                        </li>
                        @auth
                            @if(auth()->user()->email_verified_at !== null)
                                <li class="nav-item dropdown p-icon">
                                    <a class="nav-link uSREICON" data-toggle="dropdown" href="javascript:void(0);" aria-expanded="true">
                                        <i class="far fa-user" style="font-size: 1.45rem;"></i>
                                    </a>
                                    <div class="dropdown-menu" style="left: -50px;min-width: 15rem;">
                                        <div class="p-2">
                                            <p class="text-dark small auth-name" style="margin-bottom: 0px; font-size: 15px;"> {{auth()->user()->first_name}} {{auth()->user()->last_name}}</p>
                                            <p class="text-dark small auth-email" style="margin-bottom: 0px; font-size: 12px;">{{auth()->user()->email}}</p>
                                        </div>
                            ...
                            @else
                                <li class="nav-item">
                                    <a href="{{route('auth.logout')}}" class="logout nav-link" onclick="event.preventDefault();
                                            document.getElementById('logout-form2').submit();" style="color: #6f3c96;" title="Logout">
                    ...
                    <ul class="navbar-nav sm-nav-bar">
                        ...
                        @auth
                            ...
                            @else
                                <li class="nav-item">
                                    <a href="{{route('auth.logout')}}" class="logout nav-link" onclick="event.preventDefault();
                                            document.getElementById('logout-form3').submit();" style="color: #6f3c96;" title="Logout">
                                        <i class="fa fa-power-off" aria-hidden="true" style="font-size: 25px !important;"></i>
                                    </a>
                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link navigation-link link-color" href="#hiw">How it works</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link navigation-link link-color" href="#ftc">For the Creators</a>
                                    </li>
                                    @if (!Auth::user())
                                    <li class="nav-item">
                                        <a class="nav-link navigation-link link-color" href="{{route('auth.login')}}">Log In</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link navigation-link link-color" href="{{route('auth.register')}}">Sign Up</a>
                                    </li>
                                    @else
                                    <li class="nav-item">
                                        <a class="nav-link navigation-link link-color" href="{{route('user.dashboard')}}">Dashboard</a>
                                    </li>
                                    @endif
                                </ul>
                            </div>
