                        ...
                        <div class="container mt-5">
                            ...
                            <div class="row justify-content-center bg-white">
                                ...
                                <div class="p-5 col-md-10">
                                    ...
                                    <form action="{{route('user.verify.email')}}"
                                        class="mb-0 d-flex justify-content-center" method="POST">
                                        @csrf
                                    ...
                                    {{-- @elseif($user->instagram == NULL)
                                                                <h6 class="text-muted text-center">Verify Instagram to continue!</h6>
                                                                <div class="d-flex justify-content-center">
                                                                    <a href="{{route('login.instagram')}}" class="btn
                                    btn-primary btn-instagram
                                    justify-content-center align-items-center
                                    d-inline-flex">
                                    <i class="fab fa-instagram mr-2" aria-hidden="true" style="font-size: 1.5rem"></i> |
                                    Connect Instagram</a>
                                </div> --}}
                                @else
                                <form id="iform" action="{{route('user.influencer.register')}}" method="POST">
                                    @csrf
                                    ...
                                    <div id="step1" class="tab-pane">
                                        ...
                                        <div class="form-group mb-5">
                                            ...
                                            <select name="influencer_followers"
                                                ...
                                                <option value="Mega Influencers">Mega-creative (1M+ followers)
                                                </option>
                                            </select>
                                        ...
                                        <div>
                                            <div class="form-group mb-5">
                                                <label class="product-label" for="">I've created brand content
                                                    before
                                                    for
                                                    the following:</label>
...
@if ($user->email_verified_at == NULL)
<h6 class="text-center text-muted">Verify your email address</h6>
<form action="{{route('user.verify.email')}}" class="mb-0 d-flex justify-content-center" method="POST">
    @csrf
    @include('includes.creativevideo')
    <input type="hidden" name="email" value="{{$user->email}}">
    <button type="submit" class="btn btn-primary">Verify Email</button>
...
{{-- @elseif($user->instagram == NULL)
                            <h6 class="text-muted text-center">Verify Instagram to continue!</h6>
                            <div class="d-flex justify-content-center">
                                <a href="{{route('login.instagram')}}" class="btn btn-primary btn-instagram
justify-content-center align-items-center
d-inline-flex">
<i class="fab fa-instagram mr-2" aria-hidden="true" style="font-size: 1.5rem"></i> |
Connect Instagram</a>
...
@else
<form id="iform" action="{{route('user.influencer.register')}}" method="POST" style="display: none">
    @csrf
    <input type="hidden" value="{{$user->email}}" name="email" />
    <h6 class="fs-4">We have just a few
        questions to get you up and running</h6>
    <div class="form-group hWlNG">
        <label for="">I've been a creative for?</label>
        <select name="influencer_years_experience"
            class="form-select @error('influencer_years_experience') is-invalid @enderror">
            <option value="less than a year">less than 1 year</option>
            <option value="1-5">1-5 years</option>
        ...
        @enderror
        <button type="button" class="btn btn-success btn-snd mt-2 hWlNG-btn">Continue</button>
    </div>
    <div class="form-group TpYPE">
        <label for="">I have this many followers?</label>
        <select name="influencer_followers" class="form-select @error('influencer_followers') is-invalid @enderror">
            <option value="Nano Influencers">Nano-creative (1k-10k followers)</option>
            <option value="Micro Influencers">Micro-creative (10k-50k followers)</option>
            <option value="Mid tier-influencer">Mid tier-creative (50k-500k followers)</option>
            <option value="Macro Influencers">Macro-creative (500k-1M followers)</option>
        ...
        @enderror
        <button type="button" class="btn btn-success btn-snd mt-2 TpYPE-btn">Continue</button>
    </div>
    <div class="form-group ConENT">
        <label for="">I've created brand content before for the following:</label>
        <select name="influencer_previous_job"
            class="form-select @error('influencer_previous_job') is-invalid @enderror">
            <option value="an Individual">an Individual</option>
            <option value="Yourself">Yourself</option>
        ...
        @enderror
        <button type="button" class="btn btn-success btn-snd mt-2 ConENT-btn">Continue</button>
    </div>
    <div class="form-group PSERev">
        <label for="">What type of Products/Services do you produce content
            for?</label>
        <select name="inflencer_services_provided"
            class="form-select @error('inflencer_services_provided') is-invalid @enderror">
            <option value="Beauty cosmetics & fashion">Beauty cosmetics & fashion
            </option>
        ...
        @enderror
        <button type="button" class="btn btn-success btn-snd mt-2 PSERev-btn">Continue</button>
    </div>
    ...
    <div class="form-group cHarge">
        <label for="" class="form-label">What's an average fee you charge for making
            your content?</label>
        <select name="influencer_charges" class="form-select @error('influencer_charges') is-invalid @enderror">
            <option value="5000-10000">5k-10k</option>
            <option value="10000-50000">10k-50k</option>
            <option value="50000-100000">50k-100k</option>
            <option value="100000-1000000">100k-1M</option>
            <option value="1000000 and above">1M+</option>
        </select>
        @error('influencer_charges')
        <div class="invalid-feedback">
            {{$message}}
        ...
        @enderror
        <button type="button" class="btn btn-success btn-snd mt-2 cHarge-btn">Continue</button>
    </div>
    <div class="form-group Clients">
        <label for="" class="form-label">Where do you find clients who request your
            service?</label>
        <select name="influencer_clients" class="form-select @error('influencer_clients') is-invalid @enderror">
            <option value="Instagram">Instagram</option>
            <option value="Twitter">Twitter</option>
            <option value="Facebook">Facebook</option>
        </select>
        ...
        @enderror
        <button type="button" class="btn btn-success btn-snd mt-2 Clients-btn">Continue</button>
    </div>
    <div class="form-group turARND">
        <label for="" class="form-label">What is your turn-around time for making
            content?</label>
        <select name="influencer_turnaround_time"
            class="form-select @error('influencer_turnaround_time') is-invalid @enderror">
            <option value="Few hours">Few hours</option>
        ...
        @enderror
        <button type="button" class="btn btn-success btn-snd mt-2 turARND-btn">Continue</button>
    </div>
    <div class="row Handls" style="display: none;">
        <div class="form-group col-md-12">
            <label for="instagram_handle" class="form-label">What is your Instagram Handle <span
        ...
        <div class="form-group col-md-12">
            <label for="twitter_handle" class="form-label">What is your Twitter Username?</label>
        ...
        <div class="form-group col-md-12">
            <label for="tiktok_handle" class="form-label">What is your Tiktok Handle</label>
            ...
            <div class="row my-3">
                <div class="col-md-6">
                    ...
                    <select name="experience_level" id="experience_level"
                        ...
                        <option value="intermediate"> I kind of know how this works, so let’s get going. </option>
        ...
        <div class="form-group Curr">
            <label for="" class="form-label">Which currency do you prefer?</label>
            ...
            @enderror
            <button onclick="opn()" class="btn btn-success btn-snd mt-2">Finish</button>
        </div>
</form>
...
<script>
    ...
    function updateProgressBar(step) {
        ...
        const percentage = ((step - 1) / (4 - 1)) * 92; // Corrected to fill up to 100%
