...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header text-uppercase">Acceptable Use Policy Section</div>
                <form>
                    <!-- @csrf -->
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="main_header" id="title"
                                class="form-control"
                                value="{{$accepted && $accepted->title? $accepted->title : ''}}" required>
    ...
    function escapeHtml(unsafe)
{
    ...
    @if($accepted && $accepted->body)
    console.log(`{!! $accepted->body !!}`);
    $(".button").attr("disabled",true)
    setTimeout(() => 
    {
    CKEDITOR.instances['editor'].insertHtml(`{!! html_entity_decode($accepted->body) !!}`);
