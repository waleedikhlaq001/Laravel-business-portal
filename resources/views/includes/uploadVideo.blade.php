            ...
            <form method="POST" action="{{route('user.job.video.upload')}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <p class="d-none error text-center mb-0" id="errorMsg"></p>
                        @if ($wallet)
                        @if ($wallet->balance == 0)
                        <p class="error text-center mb-0"><b>Vendor is yet to credit Job Wallet</b> but cannot Watch content you upload until he does</p>
                        @endif
                        @endif
                        <div class="col-md-7">
                        ...
                        <div class="col-md-5">
                            <div class="form-group mb-5">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" value="YES" type="radio" name="kids_compliant" id="kids_compliant1" required>
                                    <label class="form-check-label" for="kids_compliant1">
                                        Yes, it&#39;s made for kids.
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" value="NO" type="radio" name="kids_compliant" id="kids_compliant2" required>
