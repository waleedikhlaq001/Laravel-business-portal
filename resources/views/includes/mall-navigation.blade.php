<nav class="navbar navbar-expand-lg border-bottom-0" style="background: #fff; box-shadow:none!important;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav">
                <li class="nav-item active"> <a class="nav-link" href=" {{ route('public.newmall')}} ">General Mall </a> </li>
                <li class="nav-item active"> <a class="nav-link" href=" {{ route('public.newmall')}} ">Products</a> </li>
                <li class="nav-item dropdown">
                    <a class="nav-link  dropdown-toggle" href="#" data-bs-toggle="dropdown"> Categories </a>
                    <ul class="dropdown-menu">
                        @foreach(DB::table("categories")->limit(25)->get() as $cat)
            ...
            <ul class="ml-auto navbar-nav">
                <li class="nav-item">
                    <a href="#offcanvasTop" class="nav-link" type="button" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasTop" aria-controls="offcanvasTop">
                        Search
                        <i class="fa fa-search ml-2 mr-4" aria-hidden="true"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('mall.checkout') }}" class="nav-item position-relative">
                        <svg class="mr-2 mt-2" width="22" height="22" viewBox="0 0 26 26" fill="none"
                        ...
                        <span id="vicomma-cart-cta" class="badge badge-warning navbar-badge"
                            style="z-index: 1; right: 0; top:0;">0</span>
                    </a>
                </li>
            </ul>
        </div> <!-- navbar-collapse.// -->
...
<div class="offcanvas offcanvas-top" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
    <div class="container">
        <div class="offcanvas-header">
            <h5 id="offcanvasTopLabel text-uppercase text-snd text-muted">What are you looking for?</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <form action="">
                <div class="form-group">
                    <div class="input-group ml-1" style="border-radius: 100px;">
                        <input type="text" placeholder="Search Products..." class="form-control"
                            style="border-radius: 100px; border: solid 1px;">
