...
@endpush
<div class="modal fade" id="withdrawWallet" tabindex="-1" role="dialog" aria-labelledby="withdrawWalletLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mb-0">
                ...
                <p class="mb-0 text-center" style="color: #885fa7;">Withdraw Money from your Wallet</p>
